...
public class ItemLookUp {
    ...
    private final String image = "div.imgTagWrapper > img";
    private final String detailUrl = "div.a-row > a[title]";
    ...
    public ItemLookUp(String html) throws IOException {
  ...
  public List<String> getDetailUrls() {
    ...
    for (Document document : documents) {
      titles.add(getDetailUrl(document));
    }
  ...
  private String getDetailUrl(Document document) {
    ...
    try {
      ...
      Elements elements = document.select(detailUrl);
